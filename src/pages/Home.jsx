...
export default function Home() {
  return (
    <div className="relative container mx-auto px-4 pt-16 pb-16">
      ...
      {/* Testimonials Carousel (still frontend) */}
      <TestimonialCarousel />
        ...
        <Accordion type="single" collapsible className="w-full mx-auto">
          {faqs.map((faq, index) => (
            <AccordionItem key={index} value={`item-${index}`}>
              ...
              <AccordionContent className="text-orange-800 text-left">
                {faq.a}
              </AccordionContent>
            </AccordionItem>
          ))}
      ...
      <div className="mt-24">
        <Card className="bg-gradient-to-r from-orange-100 to-amber-100">
          <CardContent className="p-12 text-center">
            ...
            <Button size="lg" variant="journal" className="animate-bounce bg-amber-400">
